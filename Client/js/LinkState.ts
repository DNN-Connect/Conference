...
function createHandler(component: any, key: string, property: string, type?: string) {
    return (e: any) => {
...
export function linkState(component: any, key: string, property: string, type?: string) {
