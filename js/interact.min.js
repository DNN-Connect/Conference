...
},{"./actions":8,"./scope":23,"./utils/Signals":24,"./utils/arr":25,"./utils/browser":26,"./utils/domUtils":28,"./utils/events":29,"./utils/extend":30,"./utils/isType":35}],4:[function(require,module,exports){
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
...
},{"./scope":23,"./utils":33,"./utils/Signals":24,"./utils/browser":26,"./utils/events":29,"./utils/interactionFinder":34}],5:[function(require,module,exports){
...
},{"../InteractEvent":2,"../Interactable":3,"../Interaction":4,"../defaultOptions":14,"../interact":17,"../scope":23,"../utils":33,"./index":8}],7:[function(require,module,exports){
var actions = require('./index');
var utils = require('../utils');
var InteractEvent = require('../InteractEvent');
var Interactable = require('../Interactable');
...
},{"../Interactable":3,"../Interaction":4,"../actions":8,"../defaultOptions":14,"../interact":17,"../scope":23,"../utils":33,"../utils/Signals":24,"../utils/browser":26}],14:[function(require,module,exports){
module.exports = {
  base: {
    accept: null,
    preventDefault: 'auto',
...
function collectEventTargets(interaction, pointer, event, eventTarget, eventType) {
  ...
  function collectSelectors(interactable, selector, context) {
    ...
    if (interactable._iEvents[eventType] && utils.isElement(element) && interactable.inContext(element) && utils.matchesSelector(element, selector, els)) {
...
},{"./Interaction":4,"./scope":23,"./utils":33,"./utils/browser":26}],23:[function(require,module,exports){
var scope = {};
var utils = require('./utils');
var events = require('./utils/events');
var signals = require('./utils/Signals')['new']();
