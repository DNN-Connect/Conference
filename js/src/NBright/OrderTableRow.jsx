      ...
      <tr>
        ...
        <td style={colStyle(200)}>
          <StatusButton
            ...
            onStatusChange={newStatus =>
              this.props.statusChange(this.props.order, newStatus)
            }
        ...
        <td style={colStyle(32)}>
          <button
            ...
            onClick={e => this.props.addAuditClick(this.props.order.ItemId, e)}
          >
        ...
        <td style={colStyle(32)}>
          <button
            className="btn btn-default"
            onClick={e =>
              this.props.showDetailsClick(this.props.order.ItemId, e)
            }
          >
