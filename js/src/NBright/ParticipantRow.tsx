...
interface IParticipantRowProps {
    ...
    participant: any;
    toggleParticipantRegistration: (p: any, e: any) => void;
};
      ...
      if (props.participant.AttendeeUserId) {
        btn = (
          <button
            ...
            onClick={e =>
              props.toggleParticipantRegistration(
                props.participant,
                e
              )
            }
    ...
    return (
      <tbody>
        ...
        <tr>
          <td colSpan={4}>
            <em>
              Staying from {moment(props.participant.Arrival).format("l")}{" "}
              to {moment(props.participant.Departure).format("l")}
            </em>
          </td>
        </tr>
      </tbody>
