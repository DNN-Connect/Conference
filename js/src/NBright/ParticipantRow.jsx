export default class ParticipantRow extends React.Component {
  render() {
    var btn = null;
    if (
      this.props.participant.ProductName == "Attendee" &&
      (this.props.participant.OrderStatus == 40 ||
        this.props.participant.OrderStatus == 100)
    ) {
      if (this.props.participant.AttendeeUserId) {
        btn = (
          <button
            ...
            onClick={e =>
              this.props.toggleParticipantRegistration(
    ...
    return (
      <tbody>
        ...
        <tr>
          <td colSpan={4}>
            <em>
              Staying from {moment(this.props.participant.Arrival).format("l")}{" "}
              to {moment(this.props.participant.Departure).format("l")}
            </em>
          </td>
        </tr>
      </tbody>
