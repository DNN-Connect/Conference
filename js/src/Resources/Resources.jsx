...
var Resources = React.createClass({
  ...
  render: function() {
    ...
    if (this.props.canAdd) {
      ...
      <div className="form-group">
        ...
        <div className="input-group">
          ...
          <a href="#" className="input-group-addon btn btn-default" onClick={this.addUrl}>{this.resources.Add}</a>
        </div>
      </div>
        );
    }
    var resourceList = this.state.resources.map(function(item) {
      ...
      return (
        <Resource resource={item} key={item.SessionResourceId} moduleId={this.props.moduleId}
    ...
    var embeddedContent = this.state.resources.map(function(item) {
      ...
      return (
        <Video resource={item} key={item.SessionResourceId} moduleId={this.props.moduleId}
           approveResource={this.approveResource} deleteResource={this.deleteResource} editResource={this.editResource}
           resourceDir={this.props.resourceDir} canAdd={this.props.canAdd} />
        );
      }
