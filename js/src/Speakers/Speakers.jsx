...
export default class AttendanceButton extends React.Component {
  ...
  render() {
    var speakers = this.state.speakers.map(
      function(item) {
        return (
          <Speaker
      ...
      function() {
        ...
        $(this.refs.speakersTable.getDOMNode()).sortable({
          update: function(event, ui) {
            this.service.orderSessionSpeakers(
              this.props.conferenceId,
  ...
  onDelete(speaker, e) {
    ...
    if (confirm(this.resources.SpeakerDeleteConfirm)) {
      this.service.deleteSessionSpeaker(
        this.props.conferenceId,
        this.props.sessionId,
        speaker.SpeakerId,
        function(data) {
  ...
  onSpeakerAdd(e) {
    ...
    if (newUserId != "") {
      ...
      this.service.addSessionSpeaker(
        this.props.conferenceId,
        this.props.sessionId,
        this.refs.newSpeakerId.getDOMNode().value,
        function(data) {
